...
namespace FlightRecorder.Client.SimConnectMSFS
{
    public partial class Connector
    {
        ...
        {
            logger.LogDebug("Toggle parking brake");
            simconnect.TransmitClientEvent(SimConnect.SIMCONNECT_OBJECT_ID_USER, EVENTS.PARKING_BRAKES, 0, GROUPS.GENERIC, SIMCONNECT_EVENT_FLAG.GROUPID_IS_PRIORITY);
        }
